...
##        self.event = QMouseEvent(MouseButtonPress)
...
##        self.QObject.connect(self.trayIcon, SIGNAL(traySignal), self.__icon_activated)
...
##        self.setMask()
        self.setAttribute(Qt.WA_TranslucentBackground, True)
                        #position  #size
        self.setGeometry(1350,0, 350,25)
